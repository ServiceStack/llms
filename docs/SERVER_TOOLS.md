...
> [!IMPORTANT]
> Only providers that define a `"server_tools"` array will have the **SERVER TOOLS** tab enabled and configure their UI to use them.
...
![Client Tools Selector](./img/tools_selector_client.png)
...
![Server Tools Selector Tab](./img/tools_selector_server.png)
...
![Configure Server Tool](./img/tools_selector_server_config.png)
